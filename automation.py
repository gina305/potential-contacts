...
* To run this project, ru the automation.py script.
...
def get_data():
    ...
    file.close()
    res = [] # Used for trcking numbers and emails
    ...
    for number in found_contacts:
        ...
        #Write to destination file once
    ...
    emails = [] 
    #Change destination file and write unique emails
